...
Partial Class FormFGLineList
    ...
    Private Sub InitializeComponent()
        ...
        Me.BtnActualCost = New DevExpress.XtraEditors.SimpleButton()
        Me.BtnEstimateCost = New DevExpress.XtraEditors.SimpleButton()
        ...
        CType(Me.PCUnlock, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.PCUnlock.SuspendLayout()
        CType(Me.CheckEditUnlock.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.PanelControlNavLineListBottom.Controls.Add(Me.BtnEstimateCost)
        Me.PanelControlNavLineListBottom.Controls.Add(Me.PCSelAll)
        Me.PanelControlNavLineListBottom.Controls.Add(Me.PBCLineList)
        Me.PanelControlNavLineListBottom.Controls.Add(Me.BtnCopyFrom)
        ...
        Me.PCUnlock.Controls.Add(Me.CheckEditUnlock)
        ...
        'CheckEditUnlock
        '
        Me.CheckEditUnlock.Location = New System.Drawing.Point(5, 7)
        Me.CheckEditUnlock.Name = "CheckEditUnlock"
        Me.CheckEditUnlock.Properties.Caption = "Unlock Feature"
        Me.CheckEditUnlock.Size = New System.Drawing.Size(100, 19)
        Me.CheckEditUnlock.TabIndex = 102
        Me.CheckEditUnlock.Visible = False
        '
        'BtnProposePrice
        '
        ...
        CType(Me.PCUnlock, System.ComponentModel.ISupportInitialize).EndInit()
        Me.PCUnlock.ResumeLayout(False)
        CType(Me.CheckEditUnlock.Properties, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents SMEditDesign As System.Windows.Forms.ToolStripMenuItem
    ...
    Friend WithEvents SMViewDupe As System.Windows.Forms.ToolStripMenuItem
    ...
    Friend WithEvents BtnEstimateCost As DevExpress.XtraEditors.SimpleButton
    ...
    Friend WithEvents PCUnlock As DevExpress.XtraEditors.PanelControl
    Friend WithEvents CheckEditUnlock As DevExpress.XtraEditors.CheckEdit
    Friend WithEvents SMViewCostHist As System.Windows.Forms.ToolStripMenuItem
    Friend WithEvents BBDs As DevExpress.XtraBars.BarButtonItem
    Friend WithEvents SMDeleteDesign As System.Windows.Forms.ToolStripMenuItem
    Friend WithEvents SMViewHistoryPD As System.Windows.Forms.ToolStripMenuItem
    Friend WithEvents SMViewPD As System.Windows.Forms.ToolStripMenuItem
    Friend WithEvents BtnCreateNewPD As DevExpress.XtraEditors.SimpleButton
    Friend WithEvents BtnProposePrice As DevExpress.XtraEditors.SimpleButton
    Friend WithEvents BtnActualCost As DevExpress.XtraEditors.SimpleButton
