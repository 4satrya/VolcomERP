Public Class FormFabricTypeDet
    ...
    Private Sub BSave_Click(sender As Object, e As EventArgs) Handles BSave.Click
        ...
        Else
            'check ada yang sama
            Dim qc As String = "SELECT * FROM tb_m_fabric_type WHERE fabric_type_name='" & fabric_type & "' OR fabrication='" & fabrication & "'"
            Dim dtc As DataTable = execute_query(qc, -1, True, "", "", "", "")

            If dtc.Rows.Count > 0 Then
                warningCustom("Fabric type/fabrication already registered on list.")
            Else
                If id = "-1" Then 'new
