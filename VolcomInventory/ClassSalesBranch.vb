Public Class ClassSalesBranch
    Public Function queryMain(ByVal condition As String, ByVal order_type As String) As String
        ...
        b.rev_normal_ppn, b.rev_normal_ppn_acc AS `id_coa_ppn_normal`, coa_ppn_normal.acc_name AS `coa_ppn_normal`, coa_ppn_normal.acc_description AS `coa_ppn_normal_desc`,
        b.rev_normal_before_ppn,  b.rev_normal_before_ppn_acc AS `id_coa_pend_normal`, coa_pend_normal.acc_name AS `coa_pend_normal`, coa_pend_normal.acc_description AS `coa_pend_normal_desc`,
        ...
        b.rev_sale_ppn, b.rev_sale_ppn_acc AS `id_coa_ppn_sale`, coa_ppn_sale.acc_name AS `coa_ppn_sale`, coa_ppn_sale.acc_description AS `coa_ppn_sale_desc`,
        b.rev_sale_before_ppn,  b.rev_sale_before_ppn_acc AS `id_coa_pend_sale`, coa_pend_sale.acc_name AS `coa_pend_sale`, coa_pend_sale.acc_description AS `coa_pend_sale_desc`,
